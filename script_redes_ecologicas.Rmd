...
Warning 4: Null models are an endless discussion in Ecology. The choice of null models depends on your question, but is essential to test the significance of the data. Chose carefully, based on the biological meanings of the randomization process.

Warning 5: always check for updates of packages and R, specially if you start to have weird errors.
...
#### Observed the topological differences between binary and weighted networks for the different systems

#### Invaded pollination network of sub-alpine vegetation, New Zealand
...
#### Network of ant-plant interactions in a dam-fragmented island of Balbina, Central Amazon
...
#### Avian seed-dispersal network from the Ilha Anchieta, Atlantic Forest
...
#########################################################################
Now you are ready to explore other parameters of the networks and play with your drawing. Networks are a world of possibilities. Be creative and you will succeed!! 
#########################################################################
